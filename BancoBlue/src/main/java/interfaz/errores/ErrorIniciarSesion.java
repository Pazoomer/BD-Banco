 ...
 * @author victo
 */
public class ErrorIniciarSesion extends javax.swing.JFrame {

    /**
     * Creates new form ErrorIniciarSesion
     */
    public ErrorIniciarSesion() {
    ...
    private void initComponents() {
        ...
        btnConfirmar.setBounds(250, 280, 150, 37);

        jLabel2.setFont(new java.awt.Font("Corbel", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nombre de usuario o contraseña incorrectos.");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(100, 190, 445, 30);
