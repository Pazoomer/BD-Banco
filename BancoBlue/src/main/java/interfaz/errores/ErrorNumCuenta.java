 ...
 * @author victo
 */
public class ErrorNumCuenta extends javax.swing.JFrame {

    /**
     * Creates new form ErrorNumCuenta
     */
    public ErrorNumCuenta() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El número de cuenta no existe.");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(160, 190, 305, 30);
        ...
        jLabel1.setBounds(250, 100, 137, 58);
